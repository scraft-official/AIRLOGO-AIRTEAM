...
public class AddNewFunctionPopup extends JPanel {
	...
	public AddNewFunctionPopup(String functionPreset) {
		setOpaque(false);
		
		Dialog dialog = new AddNewFunctionPopup.Dialog();
      	...
      	ArrayList<String> functionArguments = new ArrayList<>();
    		...
    		for(String arg : Arrays.copyOfRange(firstLine, 2, firstLine.length)) {
    			if(arg.length() > 1 && arg.charAt(0) == ':') {
    				functionArguments.add(arg.toUpperCase());
    		...
    		if(FunctionManager.existFunction(functionName)) { hintText.setText("* FUNKCJA O TAKIEJ NAZWIE JUŻ ISTNIEJE!"); return; }
      ...
      public void actionPerformed(ActionEvent e) {
		...
		functionBodyField.setText(functionPreset);
	...
	public class Dialog extends JPanel {
		public CustomDialogFrame frame = new CustomDialogFrame("DODAJ NOWA FUNKCJE", width, height, false, false);
	}
}
