...
public class DeleteTurtlePopup extends JPanel {
	private int width = 600;
	private int height = 250;
	
	public DeleteTurtlePopup(Turtle turtle) {
		setOpaque(false);
		
		Dialog dialog = new DeleteTurtlePopup.Dialog();
		...
		text.setText("CZY CHCESZ USUNĄĆ ŻÓŁWIA \"" + turtle.getName() + "\"? \nSPOWODUJE TO WYMAZANIE WSZELKICH JEGO RYSUNKÓW!");
      ...
      public void actionPerformed(ActionEvent e) {
		...
		acceptButton.setText("USUŃ ŻÓŁWIA");
	...
	public class Dialog extends JPanel {
		public CustomDialogFrame frame = new CustomDialogFrame("CZY CHCESZ USUNĄĆ ŻÓŁWIA?", width, height, false, false);
	}
}
