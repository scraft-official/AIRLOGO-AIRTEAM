...
public class AtariLogo extends JFrame {
	public AtariLogo() {
		...
		FormLayout appLayout = new FormLayout(new ColumnSpec[] {
				ColumnSpec.decode("center:80dlu:grow"),
		...
		((Turtles_Workspace_Area) workspacePanel).addTurtle("PODSTAWOWY");
		((Turtles_Workspace_Area) workspacePanel).addTurtle("PODSTAWOWY2");
